  ...
  <div class="audit-form">
    ...
    <div v-if="activeTab === 'bits'" class="panel">
      ...
      <textarea
        ...
        rows="6"
        class="input"
        placeholder="Пример: 01011010..."
      ></textarea>
      <div class="actions">
        <button class="btn" :disabled="!bits.trim() || busy" @click="runNistFromBits">
          Запустить NIST
        </button>
      </div>
    </div>
    ...
    <div v-if="activeTab === 'numbers'" class="panel">
      ...
      <div class="actions">
        <button class="btn" :disabled="!numbers.trim() || busy" @click="runNistFromNumbers">
          Запустить NIST
        </button>
      </div>
    </div>
    ...
    <div v-if="activeTab === 'file'" class="panel">
      ...
      <div class="actions">
        <button class="btn" :disabled="!file || busy" @click="runNistFromFile">
          Запустить NIST
        </button>
      </div>
    </div>
...
const runNistFromNumbers = () =>
  runNist({ sequence_bits: null, numbers: parseNumbers(numbers.value) })
